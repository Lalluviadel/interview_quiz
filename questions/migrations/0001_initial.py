# Generated by Django 3.2.9 on 2022-01-10 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty_level', models.CharField(choices=[('NB', 'новичок'), ('AV', 'середнячок'), ('SP', 'умник')], default='NB', max_length=2, verbose_name='уровень')),
                ('available', models.BooleanField(default=True)),
                ...
                ('subject', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='questions.questioncategory')),
            ],
        ),
    ]
